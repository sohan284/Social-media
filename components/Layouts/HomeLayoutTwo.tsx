  ...
  return (
    ...
    >
      ...
      <aside
        ...
        className={`fixed left-0 top-0 h-full bg-cover bg-center bg-no-repeat shadow-md transform transition-transform duration-300 z-30 w-[370px] px-6 
      ...
      <main
        ...
        `}
      >
        <div className=" mx-auto mt-16">{children}
        </div>
      </main>
    </div>
  );
